<template>
	<div class="relative overflow-hidden bg-white">
		<div class="mx-auto max-w-7xl">
			<div
					 class="relative z-10 pt-1 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
				<svg
				...
				<main
					...
					<div class="sm:text-center lg:text-left">
						<h1
							...
							<span class="block xl:inline"> the bars of ignorance and illiteracy.</span>
						</h1>
						<p
							 class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
							Project Gutenberg’s bookshelves are hand-curated
							collections of eBooks that have similar topics.
						</p>
						<div
						...
						<div class="flex flex-col items-center justify-center mt-5 sm:items-start sm:justify-start">
							<a href="https://www-apr.lip6.fr/~buixuan/daar2021" class="text-base text-gray-500 hover:text-indigo-900">
								DAAR
							</a>
							<a href="https://gitlab.alessandroserver.com/search-engine/front" class="text-base text-gray-500 hover:text-indigo-900">
								App repository
							</a>
							<a href="https://www.gutenberg.org/" class="text-base text-gray-500 hover:text-indigo-900">
